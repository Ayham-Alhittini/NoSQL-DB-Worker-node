...
public class SelectDocumentsHandler {
    ...
    public SelectDocumentsHandler(IndexStorageManager indexStorageManager, DocumentStorageManager documentStorageManager) {
    ...
    private List<JsonNode> selectByContent(DocumentQuery query, String collectionPath) throws Exception {
        String mostSelectiveIndexField = getMostSelectiveIndexField(query.getCondition(), collectionPath);
    ...
    public String getMostSelectiveIndexField(JsonNode filter, String collectionPath) throws Exception {
